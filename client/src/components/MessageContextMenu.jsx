    ...
    >
      ...
      <div className="divide-y divide-gray-100">
        ...
        {isCurrentUser && (
          <button
            onClick={onDelete}
            className="w-full px-4 py-3 text-left text-sm hover:bg-red-50 transition-colors flex items-center gap-3"
          >
            <svg className="w-5 h-5 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
            </svg>
            <span className="text-gray-900 font-medium">Delete</span>
          </button>
        )}
      </div>
      ...
      <div className="p-2">
        <button
          onClick={onClose}
          className="w-full px-4 py-2.5 text-center text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
        >
          Cancel
        </button>
      </div>
